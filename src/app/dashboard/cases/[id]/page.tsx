              ...
              {(logsRes.data?.length ?? 0) === 0 ? (
                ...
                <div className="space-y-2">
                  {logsRes.data?.map(log => (
                    <Card key={log.id} className="flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
                      <div className="flex items-center gap-3 min-w-0">
                        <div className="flex flex-col items-start min-w-0 flex-1">
                          ...
                          {log.observations && (
                            <span className="block w-full truncate text-xs text-[#6B7569]">{log.observations}</span>
                          )}
                        </div>
                      </div>
