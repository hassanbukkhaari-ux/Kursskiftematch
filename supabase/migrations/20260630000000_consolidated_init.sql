...
-- ---------------------------------------------------------------------------
-- HELPER: is_admin()
-- SECURITY DEFINER → runs as postgres, bypasses RLS on profiles table,
-- so no infinite recursion when used inside profiles' own RLS policies.
-- ---------------------------------------------------------------------------
...
-- circular FK: match_runs.final_assignment_id -> case_assignments.id
...
VALUES
  ...
  ('11111111-0000-0000-0000-000000000003', 'Aalborg Kommune', 'ACTIVE', 'Soeren Pedersen', 'soren.pedersen@aalborg.dk', '+4587654321'),
